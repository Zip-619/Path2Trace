...
embedding_file = "data/output/case_travel/node_embeddings.npy"

print(embedding_file)

edge_file = "data/input/case_travel/edges_georgetown.txt"
flag_file = "data/input/case_travel/flag_georgetown.txt"
